"""Media player platform for Sony Legacy devices."""
...
async def async_setup_entry(
    ...
    async_add_entities([SonyMediaPlayer(coordinator, entry)])


class SonyMediaPlayer(CoordinatorEntity[SonyDataUpdateCoordinator], MediaPlayerEntity):
