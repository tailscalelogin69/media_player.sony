"""Config flow for Sony Legacy (SideView)."""
...
class SonyConfigFlow(config_entries.ConfigFlow, domain=DOMAIN):
    """Handle a config flow for Sony Legacy."""
    ...
    async def _async_create_entry(self, pin: str | None) -> FlowResult:
        ...
        assert self._device is not None
        # Ensure commands / mac are loaded.
