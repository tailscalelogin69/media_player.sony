"""Remote platform for Sony SideView devices."""
...
async def async_setup_entry(
    ...
    async_add_entities([SonySideViewRemote(coordinator, entry)])


class SonySideViewRemote(CoordinatorEntity[SonyDataUpdateCoordinator], RemoteEntity):
    ...
    def __init__(
        ...
        self._attr_unique_id = f"sony_sideview_{host}_remote"
